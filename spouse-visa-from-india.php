<?php
$title = "spouse visa from india";
include("Master/header.php");
?>

<!-- slide background gradient -->
<div class="align-items-center text-center " style="background-image: url(picture/header-background/spouse-visa.jpg);background-size: cover;background-repeat: no-repeat;background-attachment: fixed; height: 500px;">
<div class="container">
  <div class="row text-center  justify-content-center align-items-center " >
    <div class="col-lg-9" style="margin-top: 192px;text-align: center;">
    
      <h1 class="text-white  border-radius-lg font-weight-bolder bg-gradient-primary" style=" letter-spacing: 10px; font-size: 100px; margin: 0 auto;text-shadow: 1px 1px 5px black;">
      CANADA
      </h1>

      <p class="bg-gradient-info  text-white border-radius-lg fs-3 w-60 font-weight-bold mt-2" style="letter-spacing:4px; margin: 0 auto;text-shadow: 1px 1px 5px black;">
      Spouse Visa  
      </p>  
    </div>
...
<div class="container">
  <div class="row mt-5 " >
    <div class="col-lg-9" >
      ...
      <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">Move to Canada with your Family</h4>
      ...
      <p>
        TThe process of getting the spousal visa is different from other visa applications, as it has different requirements - education qualification, language proficiencies, or work experiences are not required. In this article, we will answer your question about how to apply for a Canada Spouse Visa.
      </p>
      <p>
      ...
      <div class=" text-center">
        <button type="button" class="btn bg-gradient-danger btn-sm mt-3" data-bs-toggle="modal" data-bs-target="#contactform">
         Apply For Spouse Visa Now
       </button>
     </div>

     

<!-- LET US HELP YOU IN FINDING YOUR NOC CODE Form -->

      <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">What is a Canadian Spouse Visa?</h4>
      ...
      <p><i class="fa-solid fa-square-check text-success"></i>  
        Rudraksh Group can help you reunite with your family with our dedicated Canada-dependent services.
      </p>
      <div class="text-center">
        <button type="button" class="btn bg-gradient-primary btn-sm mt-3" data-bs-toggle="modal" data-bs-target="#contactform">
          Check Your Spouse Eligibility
        </button>
      </div>



      <h4 class="text-primary mt-6 text-center">You can sponsor the following relations for a dependent visa:</h4>
  
      <div class="container">
            <div>
              <img src="picture/header-background/spouse-visa-pics.jpg" class="border-radius-xl shadow" style="max-width: 100%; height: auto;">
            </div>
      </div>
    ...
    <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">What is the minimum requirement to become a sponsor?</h4>

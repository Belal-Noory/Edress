...
<div class="page-header min-vh-80" style="background-image: url('picture/header-background/uk-visitor.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          <div class="text-center">
            <h1 class="text-white animate__animated animate__bounceInDown"  style="font-family:'Poppins'; letter-spacing:1px;"><span class="bg-gradient-info px-4 border-radius-lg">Germany</span></h1>
            <h1 class=" animate__animated animate__bounceInLeft">
           <span class="text-white bg-gradient-warning border-radius-lg px-4 fs-1" style="font-family:'Poppins'; letter-spacing: 1px; font-weight:normal;">Study Visa </span><br><span>
             <div class="text-center"> 
...
<div class="container">
  <div class="row mt-5 " >
    <div class="card col-lg-9 px-4 py-4" >
      ...
      <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">Germany Study Visa</h4>
      ...
      <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">Types of Germany Study Visa</h4>
      ...
      <ul class="text-justify">
        <li style="list-style-image: url(picture/icon/b1.png);">
            <p>
                <b>German Student Visa:</b> This is the regular student visa for international students who have been accepted into one of Germany's official universities and are ready to begin their studies in a university program in Germany.
            </p>
        </li>

        <li style="list-style-image: url(picture/icon/b1.png);">
            <p>
                <b>German Student Applicant Visa:</b> If you need to be in Germany to apply for university admission in person, you will require this visa. This visa does not allow you to study in Germany; it is only valid for the application process to universities.
            </p>
        </li>

        <li style="list-style-image: url(picture/icon/b1.png);">
            <p>
                <b>German Language Course Visa:</b> This type of visa is required to study for a German language course in Germany.
            </p>
        </li>
      ...
      <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">What is the eligibility for a Germany Study Visa?</h4>
      ...
      <h4 class="mt-6 fs-4 bg-gradient-dark text-white px-4 border-radius-lg shadow" style="text-shadow: 2px 2px 2px black; font-weight: normal;">What is the process to apply for a Germany Study Visa?</h4>
      ...
      <p>
      <b>STEP 1:</b> Locate The Closest German Embassy or Consulate    
      </p>
      ...
      <p>
          <b>STEP 2:</b> Review The Requirements and Procedures   
      </p>
      ...
      <p>
          <b>STEP 3:</b> Set Up A Visa Appointment   
      </p>
